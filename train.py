...
from glider.processing import DataCollator
...
def main(args):
    ...
    data_collator = DataCollator(tokenizer, feature_extractor, resize_image=True, 
                                            num_query_groups=args.num_query_groups,
    ...
    weight_dict = {
                #    'loss_ce': args.ce_loss_coef, 
                   ...
                   'loss_vfl': args.vfl_loss_coef,
                   'loss_giou': args.giou_loss_coef
    }

    criterion = SetCriterion(num_classes=args.max_objects, matcher=matcher, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='models/owl')
    parser.add_argument('--data_path', type=str, default='data/grit_high_res')
    parser.add_argument('--batch_size', type=int, default=8)
    parser.add_argument('--eval_batch_size', type=int, default=16)
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--model_type', type=str, default='owl')#owl
    parser.add_argument('--vision_model', type=str, default='google/vit-base-patch16-224')
    parser.add_argument('--language_model', type=str, default='openai/clip-vit-base-patch16')
    ...
    parser.add_argument('--language_model_lr', type=float, default=5e-6)
    parser.add_argument('--vision_model_lr', type=float, default=5e-6)
    ...
    parser.add_argument('--focal_loss', type=bool, default=True)
    parser.add_argument('--focal_alpha', type=float, default=0.9)
    parser.add_argument('--focal_gamma', type=float, default=2.0)
    parser.add_argument('--bbox_loss_coef', type=float, default=3.0)
    ...
    parser.add_argument('--vfl_loss_coef', type=float, default=1.0)
    parser.add_argument('--obj_loss_coef', type=float, default=1.0)
    ...
    parser.add_argument('--from_pretrained', type=str, default='google/owlv2-base-patch16')
